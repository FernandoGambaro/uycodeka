	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">MODIFICAR PROVEEDOR <?php echo $codproveedor?> </div>
				<div id="frmBusqueda">
				...
				<table class="fuente8" width="100%" border="0"><tr><td>
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
						<tr>
						    ...
						    <td width="43%"><input name="Anombre" type="text" class="cajaGrande" id="nombre" data-alt="Nombre" size="45" maxlength="45" value="<?php echo mysqli_result($rs_query, 0, "nombre")?>" data-index="1"></td>
				        </tr>
						<tr>
						  <td>RUT</td>
						  <td><input id="nif" type="text" class="cajaPequena" name="anif" maxlength="15" data-alt="RUT" value="<?php echo mysqli_result($rs_query, 0, "nif")?>" data-index="2"></td>
				      </tr>
					  <?php
					  ...
					  ?>
						...
						<tr>
							<td>Rubro</td>
							<td><input id="rubro" name="arubro" type="text" class="cajaGrande" maxlength="64" value="<?php echo mysqli_result($rs_query, 0, "rubro")?>" data-index="11"></td>
					    </tr>
						<tr>
						...
						<tr>
							...
							<td><input id="horario" type="text" class="cajaGrande" name="horario" maxlength="20" value="<?php echo mysqli_result($rs_query, 0, "horario")?>" data-index="15"></td>
					    </tr>						    				    
					</table>
				</td></tr></table>
			  </div>
