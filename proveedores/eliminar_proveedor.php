	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">ELIMINAR PROVEEDOR <?php echo $codproveedor?> </div>
				<div id="frmBusqueda">
					...
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
					  ...
					  ?>
						...
						<tr>
							...
							<td><input id="telefono" name="atelefono" type="text" class="cajaPequena" maxlength="14" value="<?php echo mysqli_result($rs_query, 0, "telefono")?>" data-index="9"></td>
					    </tr>
						<tr>
							<td>M&oacute;vil</td>
							<td><input id="movil" name="amovil" type="text" class="cajaPequena" maxlength="14" value="<?php echo mysqli_result($rs_query, 0, "movil")?>" data-index="10"></td>
					    </tr>
						<tr>
							<td>Correo&nbsp;electr&oacute;nico  </td>
							<td><input name="aemail" type="text" class="cajaGrande" id="email" size="35" maxlength="35" value="<?php echo mysqli_result($rs_query, 0, "email")?>" data-index="11"></td>
					    </tr>
												<tr>
							<td>Direcci&oacute;n&nbsp;web </td>
							<td><input name="aweb" type="text" class="cajaGrande" id="web" size="45" maxlength="45" value="<?php echo mysqli_result($rs_query, 0, "web")?>" data-index="12"></td>
					    </tr>
						<tr>
							<td>Nº&nbsp;Cuenta&nbsp;bancaria</td>
							<td><input id="cuentabanco" type="text" class="cajaGrande" name="acuentabanco" maxlength="20" value="<?php echo mysqli_result($rs_query, 0, "cuentabancaria")?>" data-index="13"></td>
					    </tr>
						<tr>
							<td>Horario de atención</td>
							<td><input id="horario" type="text" class="cajaGrande" name="horario" maxlength="20" value="<?php echo mysqli_result($rs_query, 0, "horario")?>" data-index="14"></td>
					    </tr>					    					    
					</table>
				</td></tr></table>
			  </div>
			  <br style="line-height:5px">
				<div>
						<button class="boletin" onClick="validar(formulario,true);" onMouseOver="style.cursor=cursor"><i class="fa fa-erase" aria-hidden="true"></i>&nbsp;Eliminar</button>
