...
$query="SELECT * FROM usuarios WHERE codusuarios='$usuario'";
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR CONTROL HORA VARIOS DÍAS</div>
				<div id="frmBusqueda">
					...
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
						...
						<?php
								if(""!==(trim($usuario))) {
									...
									$nombre = mysqli_result($rs_bus, 0, "nombre").' '. mysqli_result($rs_bus, 0, "USUARIOAPE");							
								}
							?>					
							<td>Usuario</td>
						    <td colspan="2">
						    <input name="usuarios" type="text" onfocus="this.select();" class="cajaGrande" id="Ausuarios" size="45" value="<?php echo $nombre;?>" maxlength="45" onFocus="this.style.backgroundColor='#FFFF99'">
						...
						<tr>
						  <td>Fecha&nbsp;</td>
						  <td><input id="fechaini" type="text" class="cajaPequena" name="Afecha" maxlength="10" value="" readonly>
						  <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" style="vertical-align: middle; margin-top: -1px;">
						   ...
						   Calendar.setup({
							...
							<input id="fechafin" type="text" class="cajaPequena" name="Afechafin" maxlength="10" value="" readonly>
						...
						<tr>
						 <td>&nbsp;</td> 
						 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;					
								<input type="radio" name="mantar" value="0" style="vertical-align: middle; margin-top: -1px;">Mañana
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="mantar" value="1" style="vertical-align: middle; margin-top: -1px;">Tarde 						
						 </td>						
						</tr>
						<tr>
							<td>Cliente</td>
						    <td colspan="2">
						    <input name="Acliente" type="text" onfocus="this.select();" class="cajaGrande" id="Acliente" size="45" maxlength="45" onFocus="this.style.backgroundColor='#FFFF99'">
						    <input name="Acodcliente" type="hidden" id="Acodcliente" readonly >
					      </td>	
					    </tr>
						<tr>
							<td>Proyecto</td><td>
...
<select id="second-choice" style="display: none">
  <option>Seleccione una opción</option>
						    ...
						    <input name="proyectos" type="text" onfocus="this.select();" class="cajaGrande" id="proyectos" size="45" maxlength="45" onFocus="this.style.backgroundColor='#FFFF99'">
						    <input name="Acodproyectos" type="hidden" id="codproyectos" readonly >
							</td>							
						</tr>				      
				      <tr>
				      <td>Horas</td>
				      <td>
						...
						<tr>
							<td>Descripción</td>
							<td><textarea id="descripcion" name="descripcion" autocomplete="off" rows="2" cols="35" ></textarea></td>
					    </tr>					    
					</table>
				</td></tr></table>
			  </div><br>
...
Cerrar</button>				
					...
					<input id="codhoras" name="codhoras" value="alta" type="hidden" value="">
