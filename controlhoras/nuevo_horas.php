	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR CONTROL HORA</div>
				<div id="frmBusqueda">
				...
				<table class="fuente8"><tr><td valign="top">
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
						<tr>
						  ...
						  <td>Fecha</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" name="Afecha" maxlength="10" value="<?php echo date("d/m/Y");?>" readonly>
						  <img src="../img/calendario.png" name="Image2" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" style="vertical-align: middle; margin-top: -1px;">
						   ...
						   Calendar.setup({
						     ...
						     dateFormat : "%d/%m/%Y"
								...
								<input type="radio" name="Amantar" value="0" style="vertical-align: middle; margin-top: -1px;">Mañana
								<input type="radio" name="Amantar" value="1" style="vertical-align: middle; margin-top: -1px;">Tarde 						
						</td>						
...
<select id="second-choice" style="display: none">
  <option>Seleccione una opción</option>
				      ...
				      <td>
						...
						<tr>
							<td>Descripción</td><td><textarea id="descripcion" name="descripcion" autocomplete="off" rows="2" cols="35" ></textarea></td>
					    </tr>					    
					</table>
				</td></tr></table>
			  </div>
