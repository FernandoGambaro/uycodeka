...
<select id="second-choice" style="display: none">
  <option>Seleccione una opción</option>
						    ...
						    <input name="Acodproyectos" type="hidden" id="codproyectos" value="<?php echo mysqli_result($rs_query, 0, "codproyectos");?>" >
							</td>							
						</tr>	
...
Cerrar</button>				
					<input id="codhoras" name="codhoras" type="hidden" value="<?php echo mysqli_result($rs_query, 0, "codhoras");?>">
