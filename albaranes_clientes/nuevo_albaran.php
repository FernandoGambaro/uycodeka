	...
	<body onload="inicio();">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Nueva Orden de Pedido </div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_albaran.php">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=2 border=0>
						<tr>
					      ...
					      <img id="botonBusqueda" src="../img/ver.png" width="16" height="16" onClick="OpenNote('ventana_clientes.php',700,450);" title="Buscar cliente" onMouseOver="style.cursor=cursor" style="vertical-align: middle; margin-top: -1px;">
					       <img id="botonBusqueda" src="../img/cliente.png" width="16" height="16" onClick="validarcliente()" title="Validar cliente" onMouseOver="style.cursor=cursor" style="vertical-align: middle; margin-top: -1px;"></td>
							<td>Nombre</td>
						    <td colspan="6"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" value="" readonly>
						    &nbsp;Solicitado&nbsp;por
						    <input NAME="solicitado" type="text" class="cajaGrande" id="solicitado" size="45" value="" maxlength="45"></td>
						</tr>
						<tr>
				            <td >RUT</td>
						...
						//]]></script></td>
				            <td>Fecha Entrega</td>
				            <td >							
						    <input NAME="fechaentrega" type="text" class="cajaPequena" id="fechaentrega" size="10" maxlength="10" value="<?php echo $hoy;?>" readonly> 
						...
						//]]></script></td>
				            <td colspan="3">Lugar&nbsp;de&nbsp;Entrega
								...
								<input name="lugar" type="text" class="cajaGrande" id="lugar" size="25" maxlength="100" value="" ></span>
								</td>
						</tr>
					</table>				
													
			  </div>
			  <input id="codbarras1" name="codbarras" type="hidden">
			  ...
			  <input id="descuentogral" name="descuentogral" value="" type="hidden">
			  <input id="observacion" name="observacion" value="" type="hidden">			  
