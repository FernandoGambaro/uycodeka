...
<link rel="stylesheet" href="../../css3/css/font-awesome.min.css">
	...
	<body onLoad="inicio()" bgcolor="white">
		...
		<td>Mostrados</td><td> <select name="paginas" id="paginas" onChange="paginar()"> </select></td>          
		</table>	</td>
			  </table>
				</div>
				...
				<input type="hidden" id="e" name="e" value="<?php echo $e;?>">
					...
					<iframe width="95%" height="300" id="frame_rejilla" name="frame_rejilla" frameborder="0">
