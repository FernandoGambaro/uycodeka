			...
			<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0><tr><td valign="top" width="100%">
				<table class="fuente8" width="100%" cellspacing=2 cellpadding=3 border=0>
				  <tr>
					...
					<td>Tipo&nbsp;Service</td>
					<td><input  type="text" class="cajaGrande" size="25" readonly value="<?php if($codequipo!='' and $codequipo!=0) { echo $service; }?>"></td>
				  </tr>
				  </table>
...
<?php } ?>		
			   ...
			   <br style="line-height:5px">
				<div>
						<button class="boletin" onClick="aceptar();" onMouseOver="style.cursor=cursor"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Guardar</button>
			  </div>
			 </div>
		  </div>
		</div>
