	...
	<body>
		<div id="pagina"><p>&nbsp;</p>
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">MODIFICAR CLIENTE - <?php echo $codcliente?> </div>
				<div id="frmBusqueda">
				...
				<table class="fuente8"><tr><td valign="top">
					<table class="fuente8" cellspacing=0 cellpadding=2 border=0>
						<tr>
						    ...
						    <td colspan="3"><input name="Anombre" autocomplete="off" type="text" class="cajaGrande" id="aNombre" size="45" maxlength="45" value="<?php echo mysqli_result($rs_query, 0, "nombre");?>"  data-alt="Nombre" data-index="1"></td>
				        </tr>
						<tr>
						...
						<tr>
						  <td><select type=text size=1 name="TTiponif" id="aDocumento" class="comboPequeno" data-alt="Documento" data-index="4">
							<?php
						  ...
						  <td ><input id="nif" type="text" autocomplete="off" class="cajaPequena" name="anif" maxlength="15" value="<?php echo mysqli_result($rs_query, 0, "nif");?>" data-index="5"></td>
							<td>Estado</td>
							<td><select type=text size=1 name="Ttipo" id="aEstado" class="comboMedio" data-alt="Estado" data-index="6">
							<?php
