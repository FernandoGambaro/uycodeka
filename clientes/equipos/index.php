...
<link rel="stylesheet" href="../../css3/css/font-awesome.min.css">		
		...
		function nuevo_equipo() {
			...
			location.href="nuevo_equipo.php?e="+codcliente;
		}
		
		function imprimir() {
			var codcliente=document.getElementById("codcliente").value;
			window.open("../../fpdf/equipos.php?codcliente="+codcliente);
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
			  ...
			  <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
				...
				<?php 
				$escribir=verificopermisos('equipos', 'escribir', $UserID);
				$reportes=verificopermisos('reportes', 'leer', $UserID);
					if ($escribir=="true") { ?>
						<button class="boletin" onClick="nuevo_equipo();" onMouseOver="style.cursor=cursor"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nuevo&nbsp;equipo</button>
...
<td>			
				...
				<input type="hidden" id="cadena_busqueda" name="cadena_busqueda">
					...
					<iframe width="95%" height="330" id="frame_rejilla" name="frame_rejilla" frameborder="0">
