	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR NUEVO PROYECTO</div>
				<div id="frmBusqueda">
				...
				<table class="fuente8"><tr><td valign="top">
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
						<tr>
							...
							<input type="text" size="46" maxlength="60" id="codcliente" value="<?php echo mysqli_result($rs_query, 0, "empresa"). " - ". mysqli_result($rs_query, 0, "nombre")
							." ". mysqli_result($rs_query, 0, "apellido");?>" />
							</td>
					    </tr>
					    <tr>
						  <td>Fecha&nbsp;inicio</td>
						  <td><input id="fechaini" type="text" class="cajaPequena" name="Afechaini" maxlength="10" value="" readonly>
						  ...
						  <td><input id="fechafin" type="text" class="cajaPequena" name="fecha" maxlength="10" readonly>
				      ...
				      <td colspan="3">
						...
						<tr>
							<td>Descripción</td><td colspan="3"><textarea id="descripcion" name="descripcion" autocomplete="off" rows="2" cols="35" ></textarea></td>
					    </tr>					    
					</table>
				</td></tr></table>
			  </div>
			  <br style="line-height:5px">
				<div>
					...
					<input id="codproyecto" name="codproyecto" value="alta" type="hidden" value="">
