				...
				<table class="fuente8"><tr><td valign="top">
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
						    ...
						    <td colspan="3"><input NAME="Anombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" value="<?php echo mysqli_result($rs_query, 0, "nombre");?>"></td>
				        </tr>
						<tr>
						...
						<input type="text" size="26" NAME="secA" id="secA" class="cajaGrande"  value="<?php echo mysqli_result($rs_query, 0, "secA")?>"></input>
