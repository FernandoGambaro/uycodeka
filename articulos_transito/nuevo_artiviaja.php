...
$codartiviaja=isset($_GET['codartiviaja']) ? $_GET['codartiviaja'] : null;

$destino='';

if ($codartiviaja=="") {
	$sel_artiviaja="INSERT INTO artiviajatmp (codartiviaja,fecha) VALUE ('','$fechahoy')";
	$rs_artiviaja=mysqli_query($GLOBALS["___mysqli_ston"], $sel_artiviaja);
	$codartiviajatmp=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
} else {
	$sel_artiviaja="SELECT * FROM `artiviaja` WHERE `codartiviaja` ='$codartiviaja'";
	$rs_artiviaja=mysqli_query($GLOBALS["___mysqli_ston"], $sel_artiviaja);
}
...
function pon_prefijo_Fb (codfamilia,pref,nombre,precio,codarticulo,moneda,codservice,detalles) {
	...
	$('idOfDomElement').colorbox.close();
		...
		function ventanaArticulos(){
			var codigo=document.getElementById("aCliente").value;
			if (codigo=="") {
				showWarningToast("Debe seleccionar un cliente");
			} else {
				...
				<form id="formulario" name="formulario" method="post" action="guardar_artiviaja.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=2 border=0>
						<tr>
					      ...
					      <td colspan="2">
<input name="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" value="">
					      <input name="codcliente" type="hidden" id="aCliente" value="">
						...
						<td>Estado</td>
				      <td>
			            <select id="aEstado" name="Aestado" class="cajaPequena" data-index="2">
						...
						<td>Fecha&nbsp;salida</td>
						<td>
						    <input name="fechaenvio" type="text" class="cajaPequena" id="fechaenvio" size="10" maxlength="10" readonly data-index="3"> 
						...
						<tr><td>Empresa</td><td><input type="text" size="50" name="transportista" id="transportista" class="cajaGrande" maxlength="50"  data-index="4"></td>
						<td>Datos&nbsp;del&nbsp;Vehículo</td><td><input type="text" name="vehiculo" id="vehiculo" class="cajaGrande" size="20" maxlength="50" data-index="5"> </td>
						</tr>
						<tr><td>Chofer</td><td><input type="text" size="50" name="chofer" id="chofer" class="cajaGrande" maxlength="50" data-index="6" ></td>
						</tr>
						<tr>						
						<td>Lugar&nbsp;de&nbsp;entrega</td><td>
						<input name="adestino" type="text" class="cajaGrande" id="destino" size="20" maxlength="50" data-index="7" >
						</td>
							<td width="6%">Fecha&nbsp;entrega</td><td>
						    <input name="fecharentrega" type="text" class="cajaPequena" id="fecharentrega" size="10" maxlength="10" data-index="8"  readonly> 
						...
						&nbsp;Hora:&nbsp;<input type="text" name="hora" id="hora" size="10" class="cajaPequena"  data-index="9">
						</td>
						</tr>
					</table>										
			  </div>
