...
function pon_prefijo(pref,nombre,nif) {
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					...
					</table></td><td valign="top" width="34%">
	...
	if ($escribir=="true") { ?>				 	
				<img id="botonBusqueda" src="../img/botonnuevopresupuesto.jpg" height="22" border="1" onClick="nuevo_presupuesto();" onMouseOver="style.cursor=cursor">	
	<?php } 	?>									
				</div>				</td>
