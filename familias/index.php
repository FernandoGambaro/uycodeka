...
parent.document.getElementById("msganio").innerHTML="<i class='fa fa-long-arrow-right' aria-hidden='true'></i>&nbsp;  Familia de artículos";
var tst='';
...
<td valign="top">
						...
						if ($escribir=="true") { ?>						
						<button class="boletin" onClick="OpenNote('nueva_familia.php',500,400);" onMouseOver="style.cursor=cursor">
						<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nueva&nbsp;familia</button>
						<?php } ?>						
							</td>					
...
<td>			
				...
				<input type="hidden" id="stylesel" name="stylesel">
					...
					<iframe width="95%" height="340" id="frame_rejilla" name="frame_rejilla" frameborder="0" onload="setIframeHeight(this.id)" style="max-width: 800px;">
