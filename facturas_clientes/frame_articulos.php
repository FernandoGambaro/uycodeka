...
function pon_prefijo(codfamilia,referencia,codigobarras,nombre,precio,codarticulo,moneda,codservice,detalles,comision) {
	parent.pon_prefijo_a(codfamilia,referencia,codigobarras,nombre,precio,codarticulo,moneda,'',detalles,comision);
}
...
<div class="fixed-table-container-inner">
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<a href="javascript:pon_prefijo(<?php echo $codfamilia;?>,'<?php echo $referencia;?>','<?php echo $codigobarras;?>','<?php echo addslashes(str_replace('"','&quot;',$descripcion));?>','<?php echo $precio;?>','<?php echo $codarticulo;?>','<?php echo $moneda;?>','','<?php echo addslashes(str_replace('"','&quot;',$descripcion));?>','<?php echo $comision;?>');">
