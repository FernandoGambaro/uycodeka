...
if ($cadena_busqueda<>"") {
	...
	$moneda=$array_cadena_busqueda[9];
} else {
	$codcliente="";
	$nombre="";
	$numfactura="";
...
parent.document.getElementById("msganio").innerHTML="<i class='fa fa-long-arrow-right' aria-hidden='true'></i>&nbsp;  Ventas clientes";
...
function setIframeHeight(id) {
    ...
    ifrm.style.visibility = 'visible';
		...
		function hacer_cadena_busqueda() {
			...
			var cadena="";
			cadena="~"+codcliente+"~"+nombre+"~"+numfactura+"~"+cboEstados+"~"+fechainicio+"~"+fechafin+"~"+codncredito+"~"+codarticulo+"~"+Amoneda+"~";
			return cadena;
			}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="100%" cellspacing=3 cellpadding=1 border=0><tr>
					<td valign="top">
			 	<div>
...
<td>Moneda</td><td>
		 					<select  name="Amoneda" id="Amoneda" class="comboPequeno" onclick="document.getElementById('form_busqueda').submit();">
					  ...
					  <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							...
							<td><select id="cboEstados" name="cboEstados" class="comboMedio" onchange="document.getElementById('form_busqueda').submit();">
								...
								<option value="3">Cobrada Parcial</option>			
								</select></td>
					    </tr>
					  <tr>
...
<div id="lineaResultado">
			  <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0 style="max-width: 800px;">
			  	<tr>
