				...
				<div id="frmBusqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
						    ...
						    <td width="38%"><?php echo mysqli_result($rs_query, 0, "codarticulo")?></td>
					        <td width="40%" rowspan="11" align="center" valign="top"><img src="../fotos/<?php echo mysqli_result($rs_query, 0, "imagen")?>" width="160px" height="140px" border="1"></td>
						</tr>
						<tr>
							<td width="22%">Referencia</td>
							<?php $referencia=mysqli_result($rs_query, 0, "referencia");?>
							<td width="38%"><?php echo mysqli_result($rs_query, 0, "referencia")?></td>
				        </tr>
						<?php
					  ...
					  ?>
						...
						<tr>
						    ...
						    <td width="38%"><?php echo mysqli_result($rs_query, 0, "descripcion")?></td>
				        </tr>
						<tr>
						  <td>Impuesto</td>
