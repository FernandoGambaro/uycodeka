...
function pon_prefijo(codfamilia,codigobarras,referencia,descripcion,precio_compra,codarticulo,moneda,descripcion) {
	parent.pon_prefijo_a(codfamilia,codigobarras,referencia,descripcion,precio_compra,codarticulo,moneda,descripcion);
}
...
//				if ($todos==1) { 
        ...
        <div align="left"><?php echo utf8_encode($descripcion);?></div></td>
					...
					<a href="javascript:pon_prefijo('<?php echo $codfamilia;?>','<?php echo $codigobarras;?>','<?php echo $referencia;?>','<?php echo htmlentities($descripcion, ENT_QUOTES);?>','<?php echo $precio_compra;?>','<?php echo $codarticulo;?>','<?php echo $moneda;?>','<?php echo $descripcion;?>')">
