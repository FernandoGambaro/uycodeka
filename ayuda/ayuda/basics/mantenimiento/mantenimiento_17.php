...
$pagina=array(0=>'mantenimiento_161.php',1=>'../04_documentos.php' );
/*La estructura de l array es: titulo pagina anterioer, titulo pagina sigiente*/
$titulo=array( 0=>'3.16.1. Altas, Bajas, Modificaciones de Monedas.', 1=>'4. Menú Documentos.');
    ...
    <div class="related">
      ...
      <ul>
        <li class="right" style="margin-right: 10px">
          <a href="../../genindex.php" title="Índice General" accesskey="I">índice</a></li>
        <li class="right" >
