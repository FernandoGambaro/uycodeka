...
<script type="text/javascript" src="../common/flot/jquery.flot.stack.min.js"></script>
	...
	<script language="javascript" type="text/javascript" src="../common/flot/jquery.flot.stack.js"></script>
...
<div id="placeholder" style="width:660px;height:360px;" class="dolgraph"></div>
<script>
...
if (codcliente!='0' && codusuario=='') {
    ...
    var options = {
        ...
        xaxis: {ticks: [[1,'Ene'], [2,'Feb'], [3,'Mar'], [4,'Abr'], [5,'May'], [6,'Jun'], [7,'Jul'], [8,'Ago'], [9,'Set'], [10,'Oct'],[11,'Nov'],[12,'Dic']]},
        legend:{         
...
<table class="noborder" width="100%"><tr class="liste_titre">
<td>Detalles<br></td><td align="right">
<a href="#">
<img src="../img/xls.png" alt="" title="<?php echo date("d/m/Y");?>" class="inline-block valigntextbottom"></a> 
 </td></tr>
<tr class="impair"><td colspan="2" class="nohover" align="center"><!-- Build using jflot -->
<div id="leyenda" style="width:660px;height:360px;" class="dolgraph"></div>
...
var mes=i;
        ...
        type:'post', 
        dataType: 'json',
        data: {codusuario:codusuario, mes:mes, anio:anio},
