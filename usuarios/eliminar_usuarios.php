			...
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					<table class="fuente8" cellspacing=0 cellpadding=2 border=0 >
						...
						<select  type="text" size="1"  id="tratamiento" class="comboGrande"  onchange="document.getElementById('Atratamiento').value =this.value;" disabled>					
						<?php
						$Tipox = array(
									0=>'Seleccione uno',
						        1=>"Usuario",
						...
						<td><input type="text" size="30" name="Anombre" id="aNombre" value="<?php echo mysqli_result($rs_query, 0, "nombre")?>" class="cajaGrande" disabled></input>
						</td><td width="100px" >&nbsp;Apellido</td>
						<td><input type="text" size="30" name="aapellido" id="aApellido" value="<?php echo mysqli_result($rs_query, 0, "apellido")?>" class="cajaGrande" disabled></input>
						</td></tr>
						
						<tr><td>&nbsp;Tel&eacute;fono</td>
						<td><input  type="text" size="30" name="atelefono" id="telefono" value="<?php echo mysqli_result($rs_query, 0, "telefono")?>" class="cajaGrande"  disabled></input>
						</td><td width="100px" >&nbsp;Celular</td>
						<td><input  type="text" size="30" name="acelular" id="celular" value="<?php echo mysqli_result($rs_query, 0, "celular")?>" class="cajaGrande" disabled></input>
						</td></tr>
						
						<tr>
						<td width="100px">&nbsp;eMail</td>
						<td><input  type="text" size="30" name="aemail" id="email" value="<?php echo mysqli_result($rs_query, 0, "email")?>" class="cajaGrande" disabled></input>
						</td>
							...
							<table class="fuente8" width="100%" cellspacing=1 cellpadding=2 border=0>
								...
								<tbody>
								   ...
								   $contador=0;								
									...
									<label><input class="checkbox1" type="checkbox" name="PERMISOS[<?php echo $xsector;?>_v]" value="<?php echo $xsector;?>_v" <?php echo $leer;?> disabled>
									<span></span></label></td>
									<td><label><input class="checkbox1" type="checkbox" name="PERMISOS[<?php echo $xsector;?>_c]" value="<?php echo $xsector;?>_c" <?php echo $escribir;?> disabled><span></span></label></td>
									<td><label><input class="checkbox1" type="checkbox" name="PERMISOS[<?php echo $xsector;?>_m]" value="<?php echo $xsector;?>_m" <?php echo $modificar;?> disabled><span></span></label></td>
									<td><label><input class="checkbox1" type="checkbox" name="PERMISOS[<?php echo $xsector;?>_e]" value="<?php echo $xsector;?>_e" <?php echo $eliminar;?> disabled><span></span></label></td>
									</tr>
									<?php } ?>
						...
						<td>&nbsp;Dirección</td>
						<td><input type="text" size="30" name="adireccion" id="direccion" value="<?php echo mysqli_result($rs_query, 0, "direccion")?>" class="cajaGrande"  disabled></input>
						</td></tr><tr>
						<td>&nbsp;Usuario</td>
						<td><input type="text" size="30" name="Eusuario" id="usuario" value="<?php echo mysqli_result($rs_query, 0, "usuario")?>" class="cajaGrande"  disabled></input>
						</td></tr><tr>
						<td>&nbsp;Contraseña</td>
						<td><input type="password" name="Acontrasenia" id="contrasenia"  size="30" class="cajaGrande" placeholder="Escriba contraseña"   disabled></input>
						</td></tr>
						<tr><td>Pregunta</td>
						<td><?php
												 $secQ=mysqli_result($rs_query, 0, "secQ");
						?>
						<input name="secQ" id="secQ" value="<?php echo $secQ;?>" type="hidden"  disabled/>
						<select id="Pregunta"  type="text" class="comboGrande"  onchange="document.getElementById('secQ').value =this.value;" disabled>
						<?php
							$questions = array();
						...
						<td>Respuesta</td>
						<td>
						<input type="text" size="26" name="AsecA" id="aRespuesta" value="<?php echo mysqli_result($rs_query, 0, "secA");?>" class="cajaGrande" disabled></input>
						</td></tr>
				      ...
				      <div id="newItemMShow" style="display: none; position:absolute; border: 0px solid #000; z-index:10;">
				         ...
				         <div>
				         <input type="text" size="25" id="newItemMInput" onkeyup="lookup('newItemMInput',this.value,'4');" onblur="fill('newItemMInput',);" autocomplete="off"  class="boxinput" disabled/>
				         </div></div>
				      </div>
						<select name="sector[]" class="ComboBox" id="newItemMCombo" style="width: 250px; height:50px" multiple="multiple" size="2" disabled>
						<?php
			  ...
			  <br style="line-height:5px">
				<div>
						<button class="boletin" onClick="selectAll('newItemMCombo',true);validar(formulario,true);" onMouseOver="style.cursor=cursor"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Eliminar</button>
					...
					<input id="id" name="id" value="<?php echo $codusuarios;?>" type="hidden">
			      </div>
				</form>
