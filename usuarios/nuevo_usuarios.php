			...
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					<table class="fuente8" cellspacing=0 cellpadding=2 border=0 >
						...
						<input  name="Atratamiento" id="Atratamiento" type="hidden" />
...
&nbsp;&nbsp;
						...
						<tr>
						<td>&nbsp;Nº&nbsp;Documento</td>
						<td><input type="text" size="30" name="Aci" id="aci"  class="cajaGrande" ></input>
						<td>&nbsp;Nº&nbsp;empleado</td>
						<td><input type="text" size="30" name="aempleado" id="aempleado"  class="cajaMedia"></input>
						</td>
						</tr>
						<tr>
						<td>&nbsp;Medio pago</td>
						<td><input type="text" size="30" name="amedio" id="amedio"  class="cajaGrande"></input>
						</td>
						<td>&nbsp;Nº&nbsp;Cta.</td>
						<td><input type="text" size="30" name="acta" id="acta"  class="cajaGrande"></input>
						</td></tr>
						...
						<div style="height: 160px; width:335px; overflow:auto;">
							<table class="fuente8" width="100%" cellspacing=0 cellpadding=0 border=0>
								...
								<tbody>
									<?php
									/*Array con la definición de sectores del sistema*/ 
			...
			<div  align="center">
						<button class="boletin" onClick="selectAll('newItemMCombo',true); validar(formulario,true);" onMouseOver="style.cursor=cursor"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Guardar</button>
