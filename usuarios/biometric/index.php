...
if ($cadena_busqueda<>"") {
	...
	$devicename=$array_cadena_busqueda[1];
	$codubicacion=$array_cadena_busqueda[2];
} else {
	$devicename="";
	$codubicacion="";
}
...
parent.document.getElementById("msganio").innerHTML="<i class='fa fa-long-arrow-right' aria-hidden='true'></i>&nbsp;  Equipos huella digitales ";
...
function OpenList(noteId){
	...
	$.colorbox({
		...
		function hacer_cadena_busqueda() {
			...
			var cadena="";
			cadena="~"+devicename+"~"+codubicacion+"~";
			return cadena;
			}
			...
			<div id="zonaContenido">
				...
				<table class="fuente8" width="100%"><tr><td>
					<table class="fuente8" cellspacing=0 cellpadding=3 border=0>					
						...
						$reportes=verificopermisos('biometric', 'leer', $UserID);
						if ($escribir=="true") { ?>						
						<button class="boletin" onClick="nuevo_usuario();" onMouseOver="style.cursor=cursor">
						<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nuevo&nbsp;equipo</button>
						<?php } ?>							
						</td>
							<td>Equipo</td>
							<td><input id="devicename" name="devicename" type="text" class="cajaGrande" autocomplete="false" maxlength="45" value="<?php echo $devicename;?>"></td>
						</tr>
						<tr>
						<td>
						<?php 
					  ...
					  ?>
							...
							<td colspan="2"><select id="codubicacion" name="codubicacion" class="comboGrande" data-index="8">
